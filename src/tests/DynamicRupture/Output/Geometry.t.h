...
public:
  ...
  void testBasisFunctions() {
    ...
    const VrtxCoords* plusElementCoordsPtr[4]{&plusElementCoords[0],
                                              &plusElementCoords[1],
                                              &plusElementCoords[2],
                                              &plusElementCoords[3]};
    ...
    auto basisFunctions = getPlusMinusBasisFunctions(point, plusElementCoordsPtr, minusElementCoordsPtr);
